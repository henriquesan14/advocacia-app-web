...
@Component({
  ...
  standalone: true,
  imports: [ReactiveFormsModule, NzFormModule, NzInputModule, NzSelectModule, NzSwitchModule, NgxMaskDirective, BtnNovoComponent, SelectAutocompleteComponent, HasRoleDirective],
